<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminLogIn.aspx.cs" Inherits="webTasarimProje.adminLogIn" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ABB BANK - ADMİN - GİRİŞ</title>
    <style type="text/css">
        .auto-style1 {
            margin-left: 280px;
            margin-top: 127px;
...
<body style="background-color:black">
    <form id="form1" runat="server" class="auto-style1">
        <asp:Label ID="lblAdmin" runat="server" Font-Bold="True" Font-Size="50pt" ForeColor="Green" Text="ABB BANK - YETKİLİ GİRİŞ"></asp:Label>
